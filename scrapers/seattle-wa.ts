/**
 * Scraper: City of Seattle, WA
 *
 * Target: https://seattle.legistar.com
 * Documents: City Council agendas and meeting minutes via Legistar
 *
 * Run in isolation:
 *   npx tsx scrapers/seattle-wa.ts
 */

import { scrapeLegistar } from "./legistar";
import type { ScraperResult } from "./types";

const TOWNSHIP_ID_PLACEHOLDER = "00000000-0000-0000-0000-000000000016";

export async function scrapeSeattleWA(
  townshipId = TOWNSHIP_ID_PLACEHOLDER
): Promise<ScraperResult> {
  console.log("[seattle-wa] Scraping via Legistar…");
  const { documents, errors } = await scrapeLegistar("seattle");
