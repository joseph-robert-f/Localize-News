/**
 * Scraper: City of Pittsburgh, PA
 *
 * Target: https://pittsburgh.legistar.com
 * Documents: City Council agendas and meeting minutes via Legistar
 *
 * Run in isolation:
 *   npx tsx scrapers/pittsburgh-pa.ts
 */

import { scrapeLegistar } from "./legistar";
import type { ScraperResult } from "./types";

const TOWNSHIP_ID_PLACEHOLDER = "00000000-0000-0000-0000-000000000015";

export async function scrapePittsburghPA(
  townshipId = TOWNSHIP_ID_PLACEHOLDER
): Promise<ScraperResult> {
  console.log("[pittsburgh-pa] Scraping via Legistar…");
  const { documents, errors } = await scrapeLegistar("pittsburgh");
